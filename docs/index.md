...
本项目由**雄安宣武医院神经外科**（首都医科大学宣武医院雄安院区）与**北京理工大学具身空间智能实验室**（Embodied Space & AI Lab）合作开展，研发一款**手术器械护士机器助手**。

机器助手的定位是**配合器械护士和医生**，承担高频、标准化的器械识别、抓取和递交任务，减轻护士体力与注意力负担，提升手术流程的安全性和效率。

!!! note "核心定位"
    当前阶段**不是取代器械护士**，而是作为器械护士的助手，配合护士和医生完成手术器械的管理与传递。
